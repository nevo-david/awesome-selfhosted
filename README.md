...
- [Postiz](https://postiz.com/) - Self-hosted social media scheduler. Schedule social media posts, measure them, exchange them with other members, and get much help from AI (alternative to Hootsuite, Buffer, and other social media tools). ([Source Code](https://github.com/gitroomhq/postiz-app)) `Apache-2.0` `Nodejs`
